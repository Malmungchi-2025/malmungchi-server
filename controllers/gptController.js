...
exports.generateQuote = async (req, res) => {
  try {
    ...
    const levelPrompts = {
      1: `
      20대 성인 학습자의 기초 개념 독해력을 확장하는 비문학 글을 작성한다.  
      주제는 사회, 조직, 기술, 심리, 노동, 의사결정 중 하나의 기본 개념을 다루되, 일상 서사 대신 추상적 원리를 중심으로 설명한다.  
      구성: 개념 제시 → 성격 또는 원인 분석 → 작동 방식 설명 → 개념적 함의.  
      어휘: 구조, 요인, 과정, 작용, 경향, 변동, 해석 등 개념어 5개 이상 포함.  
      문장은 짧은 복문 중심으로, 정보량은 높되 난이도는 중급 이하로 유지한다.  
      ${COMMON_RULES}
      `,
    
      2: `
      20대 성인의 사고 확장과 정보 처리 능력을 강화하는 분석형 비문학 글을 작성한다.  
      주제는 사회 제도, 조직 운영, 기술 변화, 도시 구조, 인지 편향 등 복잡성이 있는 주제를 선택한다.  
      구성: 현상 제기 → 배경 요인 제시 → 기능적·구조적 분석 → 개념적 함의.  
      어휘: 상호작용, 맥락, 구조적 요인, 조정, 제약, 경향성, 해석 틀 등 중급 개념어 6개 이상 포함.  
      문장 구조는 인과·대조·분석 중심 복문으로 구성하며 정보 밀도를 높인다.  
      일상적 사례는 전체의 보조로 1회만 허용한다.  
      ${COMMON_RULES}
          `,
    
      3: `
      20대 성인의 고급 독해 및 추론 능력을 강화하는 심층 분석 글을 작성한다.  
      주제는 정책 변화, 시장 구조, 조직의 권력 관계, 기술·노동 상호작용, 정보 비대칭 등 고복잡성 주제를 선택한다.  
      구성: 문제 또는 쟁점 제기 → 구조적 배경 분석 → 요인 간 관계 정리 → 추론적 함의 도출.  
      어휘: 제도적 맥락, 구조적 긴장, 조정 비용, 효율성, 정합성, 상충, 지속 가능성 등 고급 개념어 6개 이상 포함.  
      문장 구조는 인과·조건·대조·가정 등 고난도 복문 중심으로 구성한다.  
      사례는 특정 사건이 아닌 “추상적 모델” 수준으로 간단히 제시한다.  
      ${COMMON_RULES}
      `,
    
      4: `
      20대 성인의 전문적 사고력·추론력·개념적 독해력을 극대화하기 위한 고난도 비문학 글을 작성한다.  
      주제는 제도 설계의 정당성, 기술·사회 구조의 상호작용, 담론 형성 과정, 가치 충돌, 시장 규범, 정책적 선택의 한계 등 고도 추상적 논점을 선택한다.  
      구성: 핵심 주장 제시 → 개념 간 관계와 구조적 요인 분석 → 대안적 해석 또는 반론 가능성 제시 → 압축된 이론적 함의.  
      어휘: 정당성, 규범적 기준, 구조적 상충, 제도적 합리성, 가치 간 긴장, 담론적 형성, 장기적 지속 가능성 등 고급 개념어 6개 이상 포함.  
      문장 구조는 다층적 복문·추론·대조 중심으로 매우 높은 정보 밀도를 갖되 장황함은 피한다.  
      ${COMMON_RULES}
            `,
    };
